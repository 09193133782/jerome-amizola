...
public class MainFrm extends javax.swing.JFrame {
    ...
    private BookTicketsFrm bookTicket;
    ...
    private void initComponents() {
        ...
        ratingLabel4 = new javax.swing.JLabel();
        ratingLabel5 = new javax.swing.JLabel();
        ...
        movieID1.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        movieID1.setForeground(new java.awt.Color(235, 16, 42));
        movieID1.setText("ID");
        moviePanel1.add(movieID1, new org.netbeans.lib.awtextra.AbsoluteConstraints(216, 310, -1, -1));
        ...
        ratingLabel4.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        ratingLabel4.setForeground(new java.awt.Color(235, 16, 42));
        ratingLabel4.setText("Rating");
        moviePanel1.add(ratingLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 220, -1, -1));

        ratingLabel5.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        ratingLabel5.setForeground(new java.awt.Color(235, 16, 42));
        ratingLabel5.setText("Movie ID");
        moviePanel1.add(ratingLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 290, -1, -1));
    ...
    private void getMovies() {
        ...
        // Check the number of rows before attempting to set details
        if (model.getRowCount() > 0 && idmodel.getRowCount() > 0) {
            setMovieDetails(0, id1, movieTitle1, genre1, rating1, runtime1, contentRating1, tckPrice1, uri1, movieLabel1);
        }
        if (model.getRowCount() > 1 && idmodel.getRowCount() > 1) {
            setMovieDetails(1, id2, movieTitle2, genre2, rating2, runtime2, contentRating2, tckPrice2, uri2, movieLabel2);
        }
        if (model.getRowCount() > 2 && idmodel.getRowCount() > 2) {
            setMovieDetails(2, id3, movieTitle3, genre3, rating3, runtime3, contentRating3, tckPrice3, uri3, movieLabel3);
        }
    }

    private void setMovieDetails(int rowIndex, int id, JLabel movieTitle, JLabel genre, JLabel rating, JLabel runtime, JLabel contentRating, JLabel tckPrice, String uri, JLabel movieLabel) {
        Object idValue = idmodel.getValueAt(rowIndex, 0);
        id = (idValue != null) ? (int) idValue : 0;

        Object titleValue = model.getValueAt(rowIndex, 0);
        movieTitle.setText((titleValue != null) ? "<html>" + titleValue.toString() + "</html>" : "<html>Unknown</html>");

        Object genreValue = model.getValueAt(rowIndex, 1);
        genre.setText((genreValue != null) ? genreValue.toString() : "Unknown");

        Object ratingValue = model.getValueAt(rowIndex, 2);
        rating.setText((ratingValue != null) ? ratingValue.toString() + "/10" : "Unknown/10");

        Object runtimeHValue = model.getValueAt(rowIndex, 3);
        Object runtimeMValue = model.getValueAt(rowIndex, 4);
        runtime.setText((runtimeHValue != null && runtimeMValue != null) ? runtimeHValue.toString() + "h and " + runtimeMValue.toString() + "m" : "Unknown");

        Object contentRatingValue = model.getValueAt(rowIndex, 5);
        ...
        Object posterValue = model.getValueAt(rowIndex, 8);
        movieLabel.setIcon((posterValue != null) ? parsePoster((byte[]) posterValue) : null);
    }
    ...
    private void bookNowBtn1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bookNowBtn1ActionPerformed
        if (bookTicket == null || !bookTicket.isDisplayable()) {
            bookTicket = new BookTicketsFrm(id1, userid);
            bookTicket.pack();
   ...
   String youtubeUrl = "https://www.youtube.com/watch?v=BTxCrOlgIUs";
    ...
    private void bookNowBtn2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bookNowBtn2ActionPerformed
        if (bookTicket == null || !bookTicket.isDisplayable()) {
            bookTicket = new BookTicketsFrm(id2, userid);
            bookTicket.pack();
            bookTicket.setVisible(true);
        } else {
            bookTicket.toFront();
    ...
    private void bookNowBtn3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bookNowBtn3ActionPerformed
        if (bookTicket == null || !bookTicket.isDisplayable()) {
            bookTicket = new BookTicketsFrm(id3, userid);
            bookTicket.pack();
            bookTicket.setVisible(true);
        } else {
            bookTicket.toFront();
    ...
    private javax.swing.JLabel ratingLabel4;
    private javax.swing.JLabel ratingLabel5;
