...
public class AdminMainFrm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        manageMoviesPanel.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 80, 80, 30));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (rowIndex < 0) {
            ...
            try {
                TableModel tbl = moviesTable.getModel();
                String deleteUsersQuery = "DELETE FROM `movies` WHERE id = '" + tbl.getValueAt(rowIndex, 0) + "'";

                try (PreparedStatement pst = DBConnectClass.getConnection().prepareStatement(deleteUsersQuery)) {
                    pst.executeUpdate();
                }
    ...
    public final javax.swing.JTable moviesTable = new javax.swing.JTable();
